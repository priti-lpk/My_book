                        ...
                        <div class="col-xl-10">
                            <form action="settingPro.php" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Language 1</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control select2" id = "language1" name = "language1" value="<?= $data[0]['language1'] ?>" placeholder = "Language 1" required=""/>
                                    </div>
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Language 2</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control select2" id = "language2" name = "language2" value="<?= $data[0]['language2'] ?>" placeholder = "Language 2" required=""/>
                                    </div>
                                </div>
                                <div class="form-group row">  
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <button  type="submit" id='submit-button' class="btn btn-primary btn-block w-md waves-effect waves-light">Change Now</button>
                                    </div>
                                </div>
