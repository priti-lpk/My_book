...
//get data for edit
if (isset($_GET['id'])) {
    $data = $dba->getRowAssoc("category_master", array("*"), "id=" . $_GET['id']);
}
?>
<html lang="en">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xl-10">
                            <form action="category.php" method="post" enctype="multipart/form-data">
                                ...
                                <!--                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control select2" id = "cname" name = "category_name" value="<?= (isset($_GET['id'])) ? $data[0]['category_name'] : '' ?>" placeholder = "Category Name" required=""/>
                                                                    </div>
                                                                </div>-->
                                <div class="form-group row">
                                    <?php
                                    ...
                                    if (!empty($data1)) {
                                        foreach ($data1 as $subData) {
                                            echo'<label for="example-text-input" class="col-sm-2 col-form-label">' . $subData[1] . '</label>';
                                        }
                                    }
                                    ?>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control select2" id = "language1" name = "language1" value="<?= (isset($_GET['id'])) ? $data[0]['language1'] : '' ?>" required=""/>
                                    </div>
                                    <?php
                                    $dba = new DBAdapter();
                                    ...
                                    ?>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control select2" id = "language2" name = "language2" value="<?= (isset($_GET['id'])) ? $data[0]['language2'] : '' ?>" required=""/>
                                    </div>
                                </div>
                                <div class="form-group row">  
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fas fa-table"></i>&nbsp;View Category</div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($data)) {
                                            foreach ($data as $row) {
                                                ...
                                                echo "<td><a href='add_category.php?id=" . $row['id'] . "' class='btn btn-primary waves-effect waves-light'>Edit</a>&nbsp<a href='delete.php?cid=" . $row['id'] . "' class='btn btn-primary waves-effect waves-light'>Delete</a></td>";
                                                echo "</tr>";
                                                $i++;
                                            }
                                        }
